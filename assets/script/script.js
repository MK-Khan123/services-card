...
const darkLogo = document.querySelector(".dark-logo"); //l
const lightLogo = document.querySelector(".light-logo"); // l
const linkedInDarkLogo = document.querySelector(".linkedIn-dark-logo"); // l d
const linkedInLightLogo = document.querySelector(".linkedIn-light-logo"); // l d
const automationTextBox = document.querySelector("#automation-text-box"); //
const pageFooter = document.querySelector("#page-footer"); // l
const grayRingLight = document.querySelector(".gray-ring-light");
const grayRingDark = document.querySelector(".gray-ring-dark");
const sliderBtn = document.querySelector("#slider-btn"); // l d
